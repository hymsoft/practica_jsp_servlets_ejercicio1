<%-- 
    Document   : autos
    Created on : 10/08/2022, 22:25:15
    Author     : hymsoft
--%>
...
<html>
    <head>
        ...
        <title>Argentina Programa - Ingreso de Automoviles</title>
    </head>
    <body>
        <div class="container-fluid bg-info bg-gradient vh-100">
            ...
            <div class="container bg-light shadow p-4 mt-4">
                <form action="SvAutos" method="POST">
                    <div class="row">
                        <div class="col-4 mb-3">
                            <label for="patente" class="form-label">Patente</label>
                            <input type="text" class="form-control" id="patente" name="patente" autofocus>
                        </div>
                        <div class="col-4 mb-3">
                            <label for="marca" class="form-label">Marca</label>
                            <input type="text" class="form-control" id="marca" name="modelo">
                        </div>
                        <div class="col-4 mb-3">
